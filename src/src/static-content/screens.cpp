...
std::weak_ptr<Static::Screens::Screen> Static::Screens::SelectScreen(Static::Screens::ScreenNames name) {
    ...
    return Static::Screens::SCREEN_SELECTIONS[Static::Screens::ScreenNames::NULL_SCREEN];
}